...
class StudyTracker
{
    ...
    public void InsertLog()
    {
        ...
        String decs = sobj.nextLine();

        StudyLog studyobj = new StudyLog(Dateobj, sub, dur, decs);

        Database.add(studyobj);

        System.out.println("Study log gets started successfully");
        System.out.println("--------------------------------------------------------");
...
class program901
{
    public static void main(String A[]) 
    {
        ...
        do
        {
            ...
            System.out.println("5 : Summary study log by subject");
            ...
            switch(iChoice)
            {
                ...
                case 6 :
                    System.out.println("-----------------------------------------------------");
                    System.out.println("----Thamk you for using Marvellous Study tracker-----");
                    System.out.println("-----------------------------------------------------");
                    break;
